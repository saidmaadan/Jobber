class JobsController < ApplicationController
  ...
  def index
    ...
    @jobs = @jobs.where(heading: params["heading"]) if params["heading"].present?
  end
  ...
  private
    ...
    def job_params
      params.require(:job).permit(:heading, :body, :timestamp, :external_url, :location, :city, :state, :country, :created_at)
    end
end
